...
const elementsByTagNameElement = document.getElementsByTagName('button')[0];
...
const elementById = document.getElementById('formValue');

formUsers.addEventListener('submit', (e) => {
        e.preventDefault();
        const name = formUsers.name.value;
        const surname = formUsers.surname.value;
        const age = formUsers.age.value;
        let obj = {name, surname, age}
        console.log(obj);
        elementById.innerText = `${obj.name} ${obj.surname} ${obj.age}`;
});
